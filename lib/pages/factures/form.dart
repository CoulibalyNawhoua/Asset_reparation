...
import '../interventions/details.dart';

class FormFacturePage extends StatefulWidget {
  final String uuid;
  const FormFacturePage({super.key, required this.uuid});

  @override
  State<FormFacturePage> createState() => _FormFacturePageState();
}

class _FormFacturePageState extends State<FormFacturePage> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return "Veuillez saisir le montant de la facture";
                  }
                  return null;
                },
              ),
              SizedBox(height: 20.0,),
              textButom("Ajouter une photo de la facture", () { _showPicker(imageController);}),
              _buildImageGrid(),
              const SizedBox(height: 50),
              Obx(() {
                return CButton(
                  title: "ENVOYER",
                  isLoading: factureController.isLoading.value,
